...
| GET | `/movies/genres` | Уникальные genre | 200, 400, 406, 500 |
...
| Метод | Путь | Описание | Коды ответов |
|-------|------|----------|--------------|
| GET | `/oscar/operators/get-loosers` | Операторы без Оскаров | 200, 400, 406, 502, 503, 504, 500 |
| POST | `/oscar/directors/humiliate-by-genre/{genre}` | Отобрать Оскары по жанру | 200, 400, 404, 502, 503, 504, 500 |
...
| 404 Not Found | Объект не найден / нет данных в жанре |
