...
| GET | `/movies` | Массив с сортировкой и пагинацией | 200, 400, 406, 500 |
| POST | `/movies/search` | Массив с фильтрами, сортировкой и пагинацией в теле запроса | 200, 400, 406, 415, 500 |
